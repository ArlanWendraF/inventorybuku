            ...
            <div class="container">
                <div class="row">
                    <div class="col-5">
                        ...
                        <form method="POST" action="/daftarbuku/{{$buku->id}}">
                        @method('patch')
                          @csrf
                          <div class="mb-1">
                          <div class="mb-2">
                            ...
                            <input type="number" class="form-control @error('kodebuku')is-invalid  
                             @enderror" id="kodebuku" placeholder="Masukan Kode Buku" name="kodebuku" value="{{$buku->kodebuku }}">                     
                            @error('kodebuku')
                          ...
                          <div class="mb-2">
                            ...
                            @enderror" id="judulbuku" placeholder="Masukan Judul Buku" name="judulbuku" value="{{$buku->judulbuku }}">  
                            @error('judulbuku')
                            <div class="invalid-feedback">{{$message}}</div>
                            @enderror                   
                          </div>
                          ...
                          <div class="mb-2">
                            ...
                            @enderror" id="jumlah" placeholder="Masukan Jumlah" name="jumlah" value="{{$buku->jumlah }}">  
                            @error('jumlah')
                            <div class="invalid-feedback">{{$message}}</div>
                            @enderror                   
                          </div>
      
                          <button type="submit" class="btn btn-warning my-3" onclick="return confirm('Apakah anda yakin Edit data ?')"> Edit</button>
                          <a href="{{url('/daftarbuku')}}"  class="btn btn-info my-3">Kembali</a>
                        </form> 
                        <br> 
                        </div>
                    </div>
